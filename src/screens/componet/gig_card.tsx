        ...
        <div className={style.card}>
            <div className={style.user}>
                <div className={style.user_img}>
                    <Image src={"/card_img.png"} alt="View All Icon" width={60} height={60} />
                </div>
                <div className={style.user_details}>
                    <div className={style.user_leavel}>
                        <span>Level 1</span>
                    </div>
                    <span>Thato Maselela</span>
            ...
            <div className={style.title_card}>
                <span className={style.title} >I will design UI UX for mobile app with figma for ios or android</span>
            ...
            <div className={style.gigimage}>
                <Image src={"/card_img.png"} alt="View All Icon" width={365} height={275} />

            </div>
            <div className={style.get_in_touch}>
                <div className={style.Icon}>
                    <Image src={"/heart.svg"} alt="View All Icon" width={17} height={17} />
                </div>
                <div className={style.button}>
                    <Image src={"/get_in_touch.svg"} alt="View All Icon" width={30} height={30} />
